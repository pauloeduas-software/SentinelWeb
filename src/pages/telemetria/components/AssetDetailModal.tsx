            ...
            <div className="space-y-6">
              <div className="grid grid-cols-2 gap-4">
                ...
                <div className="p-4 bg-surface-card border border-border-sutil">
                  ...
                  <div className="w-full bg-border-sutil h-1 mt-2"><div className="bg-status-success h-1" style={{ width: `${Math.min(ramPercent, 100)}%` }} /></div>
                </div>
              </div>
              <div>
                ...
                <div className="grid grid-cols-2 gap-y-6 gap-x-8 p-2">
                  ...
                  <div className="flex gap-3">
                    ...
                    <div>
                      ...
                      <div className="text-xl font-mono font-bold text-text-primary">
                        {network.rxSpeedKbps || 0} <span className="text-[10px] text-text-tertiary font-normal">Kbps</span>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="flex gap-3">
                    ...
                    <div>
                      ...
                      <div className="text-xl font-mono font-bold text-text-primary">
                        {network.txSpeedKbps || 0} <span className="text-[10px] text-text-tertiary font-normal">Kbps</span>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="flex gap-3">
                    ...
                    <div>
                      ...
                      <div className="text-lg font-mono text-text-primary">
                        {network.totalRxGb || 0} <span className="text-[10px] text-text-tertiary">Gb</span>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="flex gap-3">
                    ...
                    <div>
                      ...
                      <div className="text-lg font-mono text-text-primary">
                        {network.totalTxGb || 0} <span className="text-[10px] text-text-tertiary">Gb</span>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div className="space-y-3">
                  {disks.map((d, i) => (
                    <div key={i} className="text-xs font-mono">
                      ...
                      <div className="w-full bg-border-sutil h-1"><div className="bg-status-success h-1" style={{ width: `${Math.min(usagePercent(d.usedGb, d.totalGb), 100)}%` }} /></div>
                    </div>
                  ))}
                </div>
              </div>
            ...
            <div className="overflow-x-auto">
               <table className="w-full text-left font-mono text-xs">
                  ...
                  <tbody className="text-text-primary">
                    ...
                    {processes.length === 0 && <tr><td colSpan={2} className="py-4 text-center text-text-tertiary">Aguardando telemetria...</td></tr>}
                  </tbody>
               </table>
            </div>
          )}
