import type { Asset, Telemetry } from '@prisma/client';
...
export type PresentedAsset = Asset & { telemetries: PresentedTelemetry[] };
...
export function presentAsset(asset: Asset & { telemetries: Telemetry[] }): PresentedAsset {
  return { ...asset, telemetries: asset.telemetries.map(presentTelemetry) };
}
