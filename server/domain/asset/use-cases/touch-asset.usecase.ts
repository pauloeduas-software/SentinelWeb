...
const logger = createLogger('asset.touch');
...
export async function touchAsset(hwid: string): Promise<void> {
  try {
    ...
    logger.error(`[Asset] Falha ao registrar presença de ${shortHwid(hwid)}:`, error);
  }
}
