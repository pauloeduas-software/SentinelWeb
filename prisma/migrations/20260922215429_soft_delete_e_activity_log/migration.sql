-- DropIndex
--
-- CORRIGIDO À MÃO: o `migrate diff` gerou `DROP INDEX "users_email_key"`, que o
-- Postgres recusa (2BP01) porque esse índice sustenta uma CONSTRAINT UNIQUE —
-- só cai junto com ela. A unicidade volta no fim do arquivo, como índice parcial.
